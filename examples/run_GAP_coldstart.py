...
attack_model_name = "mistral.mistral-large-2407-v1:0" # "mistral.mistral-7b-instruct-v0:2") #"mistral.mistral-large-2402-v1:0") # "mistral.mixtral-8x7b-instruct-v0:1" # "mistral.mistral-7b-instruct-v0:2" # "mistral.mistral-large-2407-v1:0" # "mistral.mistral-large-2402-v1:0"
