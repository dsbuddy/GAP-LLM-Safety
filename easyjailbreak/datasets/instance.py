...
class Instance:
    def __init__(self, *, query:str=None, jailbreak_prompt:str=None, reference_responses:'List[str]'=None, target_responses:'List[str]'=None, eval_results:list=None, parents:list=None, children:list=None, attack_attrs=None, **kwargs):
        ...
        # Change datatype of string list to list
        if '[' in self.reference_responses and ']' in self.reference_responses:
            self.reference_responses = eval(self.reference_responses)
        ...
        self.instance_name = random_string(32)
        self.call_info = {}
        self.refinement_history = []  # Add a list to store refinement data
