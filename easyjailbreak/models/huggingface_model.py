...
import os
from .fschat_conv import SeparatorStyle, Conversation, register_conv_template, get_conv_template
...
class HuggingfaceModel(WhiteBoxModelBase):
    ...
    def create_conversation_prompt(self, messages, clear_old_history=True):
        ...
        print("Conv: {}".format(self.conversation.messages))
        print("Calling HF...")
        print("Conv:\n{}\n\n".format(self.conversation.get_prompt()))
    ...
    def generate(self, messages, input_field_name='input_ids', clear_old_history=True, **kwargs):
        ...
        #     prompt = f"<|begin_of_text|>You are a helpful assistant: {messages[0]}"
        # else:
        ...
        # prompt = self.tokenizer.apply_chat_template(messages, add_generation_prompt=True, return_dict=True, return_tensors="pt")
